...
import com.app.bespokino.model.Tool;
 ...
 */
public class NeckDialogFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.measuring_pager_neck_cuff, container, false);
      /*  modelValue = getArguments().getString("model");
        ...
        modelNumber = prefs.getInt("modelNo", 0);
        if (modelNumber<9){

            shirtImage.setImageResource(R.drawable.guide1to8);

        }else  if (modelNumber>=9){

            shirtImage.setImageResource(R.drawable.guide9to14);

        }

        TextView titleTv = (TextView)view.findViewById(R.id.title);
        titleTv.setText("NECK");
       ...
       // SharedPreferences prefs = getActivity().getSharedPreferences("modelno", 0);
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(), new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                double neckMaster = setMasterValues(modelValue);
                AppConfig.customerNeckValue = neckMaster + codeValue;
                AppConfig.NeckValue = "1";
                ((GetMeasurmentActivity) getActivity()).setCurrentItem(8, true);
...
*/
    ...
    public List getToolColorCode(){
        ...
        if (modelNumber >=9){
            toolCodeList.add(new ToolCode(R.drawable.collar1,0));
            toolCodeList.add(new ToolCode(R.drawable.collar2,-1));
            toolCodeList.add(new ToolCode(R.drawable.collar3,-2));
            toolCodeList.add(new ToolCode(R.drawable.collar4,-3));
            toolCodeList.add(new ToolCode(R.drawable.collar5,-4));
            toolCodeList.add(new ToolCode(R.drawable.collar6,-5));
            toolCodeList.add(new ToolCode(R.drawable.collar7,-6));
            toolCodeList.add(new ToolCode(R.drawable.collar8,-7));
            toolCodeList.add(new ToolCode(R.drawable.collar9,-8));
            toolCodeList.add(new ToolCode(R.drawable.collar10,-9));
            toolCodeList.add(new ToolCode(R.drawable.collar11,-10));

        }else if (modelNumber <9){

            toolCodeList.add(new ToolCode(R.drawable.neck1,0));
            toolCodeList.add(new ToolCode(R.drawable.neck2,-1));
            toolCodeList.add(new ToolCode(R.drawable.neck3,-2));
            toolCodeList.add(new ToolCode(R.drawable.neck4,-3));
            toolCodeList.add(new ToolCode(R.drawable.neck5,-4));
            toolCodeList.add(new ToolCode(R.drawable.neck6,-5));
            toolCodeList.add(new ToolCode(R.drawable.neck7,-6));
            toolCodeList.add(new ToolCode(R.drawable.neck8,-7));
            toolCodeList.add(new ToolCode(R.drawable.neck9,-8));
            toolCodeList.add(new ToolCode(R.drawable.neck10,-9));
        }
    ...
    public double setMasterValues(String model){
       ...
       for (int i=0; i<measuringToolValueList.size();i++){
           ...
           if (measuringToolValueList.get(i).getModelNo().equals(model)){
             ...
             neck = measuringToolValueList.get(i).getNectMaster();
