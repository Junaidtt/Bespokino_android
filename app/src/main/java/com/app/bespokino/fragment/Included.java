 ...
 */
public class Included extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        iFabric = new ArrayList<>();        if(getActivity().getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT){
    ...
    public class FetchFabricImageTasker extends AsyncTask<Object, Object, String> {
        ...
        protected String doInBackground(Object... voids) {
            ...
            try {
                ...
                URL url = new URL("http://www.bespokino.com/cfc/app.cfc?wsdl&method=populateFabrics&categoryID=1");
