...
/**
 * Created by bespokino on 8/15/2017 AD.
 */

public class CuffDialogFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      /*  modelValue = getArguments().getString("model");
       ...
       // shirtImage.setImageResource(R.drawable.cuff_guide);
        TextView titleTv = (TextView)view.findViewById(R.id.title);
        titleTv.setText("CUFF");
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(), new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                double cuffMaster = setMasterValues(modelValue);
                AppConfig.customerCuffValue = cuffMaster + codeValue;
                AppConfig.CuffValue =  "1";
    ...
    public List getToolColorCode(){
        ...
        if (modelNumber >=9){
            toolCodeList.add(new ToolCode(R.drawable.cuff9_1,0));
            toolCodeList.add(new ToolCode(R.drawable.cuff9_2,-1));
            toolCodeList.add(new ToolCode(R.drawable.cuff9_3,-2));
            toolCodeList.add(new ToolCode(R.drawable.cuff9_4,-3));
            toolCodeList.add(new ToolCode(R.drawable.cuff9_5,-4));
            toolCodeList.add(new ToolCode(R.drawable.cuff9_6,-5));
            toolCodeList.add(new ToolCode(R.drawable.cuff9_7,-6));
            toolCodeList.add(new ToolCode(R.drawable.cuff9_8,-7));
            toolCodeList.add(new ToolCode(R.drawable.cuff9_9,-8));


        }else if (modelNumber <9){

            toolCodeList.add(new ToolCode(R.drawable.cuff8_1,0));
            toolCodeList.add(new ToolCode(R.drawable.cuff8_2,-1));
            toolCodeList.add(new ToolCode(R.drawable.cuff8_3,-2));
            toolCodeList.add(new ToolCode(R.drawable.cuff8_4,-3));
            toolCodeList.add(new ToolCode(R.drawable.cuff8_5,-4));
            toolCodeList.add(new ToolCode(R.drawable.cuff8_6,-5));
            toolCodeList.add(new ToolCode(R.drawable.cuff8_7,-6));
            toolCodeList.add(new ToolCode(R.drawable.cuff8_8,-7));
            toolCodeList.add(new ToolCode(R.drawable.cuff8_9,-8));
        }
    ...
    public double setMasterValues(String model){
        ...
        for (int i=0; i<measuringToolValueList.size();i++){
            ...
            if (measuringToolValueList.get(i).getModelNo().equals(model)){
                ...
                cuff = measuringToolValueList.get(i).getCuffMaster();
