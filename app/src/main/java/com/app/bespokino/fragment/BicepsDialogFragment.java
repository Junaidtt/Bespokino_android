 ...
 */
public class BicepsDialogFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     /* modelValue = getArguments().getString("model");
        ...
        shirtImage.setImageResource(R.drawable.biceps_guide);
        TextView titleTv = (TextView)view.findViewById(R.id.title);
        titleTv.setText("BICEPS");
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(),new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                double biceptsMaster = setMasterValues(modelValue);
                AppConfig.customerBiceptsValue = biceptsMaster + codeValue;
                AppConfig.BiceptsValue =  "1";

                ((GetMeasurmentActivity) getActivity()).setCurrentItem(7, true);
   ...
   /* @Override
    ...
    public List getToolColorCode(){
        ...
        toolCodeList.add(new ToolCode(R.drawable.red,-0.5));
        toolCodeList.add(new ToolCode(R.drawable.yellow,-1.0));
        toolCodeList.add(new ToolCode(R.drawable.green,-1.5));
    ...
    public double setMasterValues(String model){
        ...
        for (int i=0; i<measuringToolValueList.size();i++){
            ...
            if (measuringToolValueList.get(i).getModelNo().equals(model)){
                ...
                bicepts = measuringToolValueList.get(i).getBicepsMaster();
