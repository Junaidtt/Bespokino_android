...
public class ItemBigAdapter extends BaseAdapter {
    ...
    public ItemBigAdapter(Activity activity) {
        this.activity = activity;
    }

    public ItemBigAdapter(Activity activity, List<ItemModel> users) {
        this.activity = activity;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ItemBigAdapter.ViewHolder holder = null;

        if (view == null){

            view = inflater.inflate(R.layout.grid_item_big, parent, false);
            ...
            holder = (ItemBigAdapter.ViewHolder)view.getTag();
