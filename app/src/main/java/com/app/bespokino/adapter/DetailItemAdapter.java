...
public class DetailItemAdapter extends BaseAdapter {
    ...
    public DetailItemAdapter(Activity activity) {
        this.activity = activity;
    }

    public DetailItemAdapter(Activity activity, List<ItemModel> users) {
        this.activity = activity;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null){
            ...
            view = inflater.inflate(R.layout.detail_grid_item, parent, false);
            ...
            holder = (DetailItemAdapter.ViewHolder)view.getTag();
